...
const VideoRoom = ({
  ...
  console.log(
    `Resolution: ${videoTrack?.getSettings().width}x${
  ...
  return (
    <div className="flex h-[calc(100vh-160px)] bg-white overflow-hidden">
      {/* Meeting Header */}
      <div className="fixed top-0 left-0 right-0 flex items-center p-4 bg-white z-10">
      ...
      {/* Main Content */}
      <div className="flex-1 pt-10 pb-16 px-4 relative">
        {/* Main Video */}
        {getMainStream() ? (
          <AudioPlayer
          ...
          <div className="flex space-x-3 overflow-x-auto pb-3">
            ...
            <div
              ...
              className={`flex-shrink-0 w-40 ${
                selectedUser === "local" ? "ring-4 ring-blue-500" : ""
              } cursor-pointer`}
            >
              {localStream && (
                <VideoPlayer
              ...
              if (user) {
                return (
                  <div
                    ...
                    className={`flex-shrink-0 w-40 ${
                      selectedUser === userId ? "ring-4 ring-blue-500" : ""
                    } cursor-pointer`}
                  >
                    {peerData.stream ? (
                      <VideoPlayer
      ...
      <div className="w-80 border-l border-gray-200 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {activeTab === "participants" ? (
            ...
            <ChatPanel socket={socket} userId="local" userName={username} />
          )}
        </div>
      </div>
    </div>
